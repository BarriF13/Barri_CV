...
|---     |---   |---          |---   |---    |
| <p align="center">[mnemonic](https://mnemonic-game.herokuapp.com/)</p><br><img src="images/mnemonic.png" width="400">| My final group project at Makers! A game app for training your short term memory | To project:<br> http://mnemonic-game.herokuapp.com/<br> To code:<br> https://github.com/BarriF13/mnemonic| Javascript, React, CSS, HTML, Adobe photoshop | Finalized |
...
|<p align="center"> [CSS Collection](https://css-styles-demo.netlify.app/)</p><br>[<img src="images/CSScollection.png" width="400">](https://css-styles-demo.netlify.app/) | CSS collection is a side project that I do for mastering CSS. Also I use this repo as one of my CSS resources. | To project:<br>https://css-styles-demo.netlify.app/<br> To code:<br> https://github.com/BarriF13/CSS-animation | CSS, HTML, Netlify, Adobe photoshop | Ongoing project|
